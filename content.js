...
chrome.extension.onRequest.addListener(function(request, sender, sendResponse) 
{
  ...
  case "screenshot-ismax":
    ...
    if( document.body.scrollHeight > request.maxheight ) {
      //Q.alert( { wstyle: "q-attr-no-icon", title: "baidu.com/", content: "<div style='padding: 5px;'>page is too large ( " + document.body.scrollWidth + "," + document.body.scrollHeight +" ), please download caputre assistant from <a href='http://www.baidu.com/download/assistant'>here</a> </div>" } );  
      Q.alert( { wstyle: "q-attr-no-icon", title: "baidu.com/", content: "<div style='padding: 5px;'>" +  locale_text("stringLongPageTips") + " ( " + document.body.scrollWidth + "," + document.body.scrollHeight +" )</div>"} );  
